 ...
 * 
 * @page rule within a CSS style sheet. The <code>@page</code> rule is used to
 *       specify the dimensions, orientation, margins, etc. of a page box for
 *       paged media.
 *       <p>
 *       See also the <a
 *       href='http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113'>Documen
 *       t Object Model (DOM) Level 2 Style Specification</a>.
 * @since DOM Level 2
 */
