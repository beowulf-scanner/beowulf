 ...
 *          value found in the <code>@charset</code> rule. If there was no
 ...
 *          correspond to the encoding the document actually came in; character
 *          encoding information e.g. in an HTTP header, has priority (see CSS
 *          document representation) but this is not reflected in the
 *          <code>CSSCharsetRule</code>.
 *          <p>
 *          See also the <a
 *          href='http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113'>Docume
 *          n t Object Model (DOM) Level 2 Style Specification</a>.
 * @since DOM Level 2
 */
