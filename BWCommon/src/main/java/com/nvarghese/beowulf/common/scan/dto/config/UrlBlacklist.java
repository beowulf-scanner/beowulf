 ...
 *       &lt;sequence>
 *         &lt;element name="url_pattern" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = { "urlPattern" })
@XmlRootElement(name = "url_blacklist")
public class UrlBlacklist {

	@XmlElement(name = "url_pattern", required = true)
	 ...
	 * <CODE>set</CODE> method for the urlPattern property.
	 * 
	 * <p>
