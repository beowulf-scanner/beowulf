...
public class HTMLBaseFontElementImpl extends HTMLAbstractUIElement implements HTMLBaseFontElement {
	 ...
	 * String size = this.getAttribute("size"); if(size != null) { int
	 ...
	 * new BaseFontRenderState(prevRenderState, fontNumber); } return
	 ...
	 * parentRS = parentModelNode == null ? null :
	 * parentModelNode.getRenderState(); String fontSize = null; if(parentRS !=
	 * null) { int fontNumber = HtmlValues.getFontNumberOldStyle(size,
	 * parentRS); fontSize = HtmlValues.getFontSizeSpec(fontNumber); }
	 * ComputedCSS2Properties css = new ComputedCSS2Properties(this);
	 * if(fontSize != null) { css.internalSetLC("font-size", fontSize); }
	 * if(fontFamily != null) { css.internalSetLC("font-family", fontFamily); }
	 * if(color != null) { css.internalSetLC("color", color); } return css; }
	 */
