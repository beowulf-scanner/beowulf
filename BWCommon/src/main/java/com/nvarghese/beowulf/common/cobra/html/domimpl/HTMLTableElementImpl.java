...
public class HTMLTableElementImpl extends HTMLAbstractUIElement implements HTMLTableElement {
	 ...
	 * AbstractCSS2Properties props = this.getCurrentStyle(); String heightText
	 * = props == null ? null : props.getHeight(); if(heightText == null) {
	 * return new HtmlLength(this.getAttribute("height")); } else { return new
	 ...
	 * AbstractCSS2Properties props = this.getCurrentStyle(); String widthText =
