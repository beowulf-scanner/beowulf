...
public class HTMLLinkElementImpl extends HTMLAbstractUIElement implements HTMLLinkElement {
	 ...
	 * if(this.hasAttribute("href")) { prevRenderState = new
	 * TextDecorationRenderState(prevRenderState,
	 * RenderState.MASK_TEXTDECORATION_UNDERLINE); prevRenderState = new
	 * ColorRenderState(prevRenderState, this.getLinkColor()); } return
