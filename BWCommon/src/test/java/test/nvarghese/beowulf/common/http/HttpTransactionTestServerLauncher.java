package test.nvarghese.beowulf.common.http;
...
public class HttpTransactionTestServerLauncher {

	private RequestListenerThread requestListener = null;
	private File tempDir = null;

	static Logger logger = LoggerFactory.getLogger(HttpTransactionTestServerLauncher.class);

	@BeforeTest(groups = "BW_http_txn_test")
	...
	@AfterTest(groups = "BW_http_txn_test")
